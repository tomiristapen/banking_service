...
type PaymentRequest struct {
	...
	Category      string                 `protobuf:"bytes,3,opt,name=category,proto3" json:"category,omitempty"` // можно пусто, если кастомная     // можно опустить
...
func (x *PaymentRequest) GetMerchant() string {
	if x != nil {
		return x.Merchant
	}
	return ""
...
const file_payment_proto_rawDesc = "" +
	"\n" +
	"\rpayment.proto\x12\apayment\"\x15\n" +
	"\x13ListServicesRequest\"2\n" +
	"\x14ListServicesResponse\x12\x1a\n" +
	"\bservices\x18\x01 \x03(\tR\bservices\"\x93\x01\n" +
	...
	"\bmerchant\x18\x05 \x01(\tR\bmerchant\"b\n" +
	...
	"\x06status\x18\x01 \x01(\tR\x06status2\xfd\x01\n" +
	"\x0ePaymentService\x12T\n" +
	"\x15ListAvailableServices\x12\x1c.payment.ListServicesRequest\x1a\x1d.payment.ListServicesResponse\x12B\n" +
	"\rPayForService\x12\x17.payment.PaymentRequest\x1a\x18.payment.PaymentResponse\x12Q\n" +
	"\x10GetPaymentStatus\x12\x1d.payment.PaymentStatusRequest\x1a\x1e.payment.PaymentStatusResponseBIZGgithub.com/tomiristapen/banking_service/payment_service/proto;paymentpbb\x06proto3"
